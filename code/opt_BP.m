function [SINR, W_jn, alpha, beta, Pj, pk] = opt_BP(theta_AP, Hjnk, Gijn, Phiij, P, sigma2_r, sigma2_c, Nsub, XPD, Rc,alg)
% BP-only optimization
% Fixed: AP selection (geometric), polarization (circular)
% Dynamic: Interference-aware subcarrier allocation, beamforming
...
% Fixed initialization - circular polarization
pjm = [1; 1]/sqrt(2);
...
if Pmin >= P
    fprintf('Warning: Cannot satisfy comm constraints with fixed configuration\n');
end
