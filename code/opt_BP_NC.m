function [SINR, W_jn, alpha, beta, Pj, pk] = opt_BP_NC(theta_AP, Hjnk, Gijn, Phiij, P, sigma2_r, sigma2_c, Nsub, XPD, Rc,alg)
% BP-NC optimization
% Fixed: Polarization (circular)
% Dynamic: AP selection, interference-aware subcarrier allocation, beamforming
...
if Pmin >= P
    fprintf('Warning: Cannot satisfy comm constraints with bistatic AP selection\n');
end

% Initialize radar beamforming
[Wr_jn, SINR] = initialize_Wr_grouped(theta_AP, Gijn, Phiij, P-Pmin, sigma2_r, XPD, Pj, alpha, beta,Nsub);

% ============= Stage 2: Beamforming Optimization Only (Fixed Polarization) =============
